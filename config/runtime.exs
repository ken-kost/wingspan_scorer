...
#
#     PHX_SERVER=true bin/wingspan_scorer start
#
...
config :wingspan_scorer, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
config :wingspan_scorer,
  token_signing_secret:
    System.get_env("TOKEN_SIGNING_SECRET") || "QUtInyjE9Zh5cpXFE/Nwj7oijG62AqFZ"
